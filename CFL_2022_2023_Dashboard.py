...
#     style={'font-family': 'Arial, sans-serif', 'background-color': '#f4f4f2', 'padding': '20px'},
    # Title
        ...
        html.Div([
            dcc.Graph(
            id='big-play',
            figure=create_big_play_analysis()  # Call the function here
            ),
            html.P("In football, games are often won or lost by big plays. Here, we can see how well each team gained or allowed big plays, and what type of plays they are. As expected, the top teams were near the top in both big plays gained and allowed. Strong passing offenses led to teams gaining a lot of yardage through the air, and these plays were most common for teams. Toronto, who was one of the strongest defensive team, was especially good at stopping big runs. Their ability to hold opponents to only 2 big runs was definitely a strong factor in their league leading rushing defense", style={'margin-top': '10px'}),
        ], style={'border': '1px solid #ddd', 'box-shadow': '2px 2px 2px lightgrey', 'padding': '20px', 'margin-bottom': '30px', 'background-color': 'white'}),
